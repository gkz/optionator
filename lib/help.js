...
(function(){
  ...
  generateHelp = function(arg$){
    ...
    return function(arg$){
      var ref$, showHidden, interpolateData, ref1$, maxWidth, output, out, data, optionCount, totalPreLen, preLens, i$, len$, item, that, pre, desc, preLen, sortedPreLens, maxPreLen, preLenMean, x, padAmount, descSepLen, fullWrapCount, partialWrapCount, descLen, totalLen, initialSpace, wrapAllFull, i, wrap;
      ref$ = arg$ != null
        ? arg$
        : {}, showHidden = ref$.showHidden, interpolateData = (ref1$ = ref$.interpolateData) != null
        ? ref1$
        : {};
      maxWidth = stdout != null && stdout.isTTY ? stdout.columns - 1 : null;
      output = [];
      ...
      if (prepend) {
        out(interpolate(prepend, interpolateData));
        out();
      }
      data = [];
      optionCount = 0;
      ...
      if (append) {
        out();
        out(interpolate(append, interpolateData));
      }
