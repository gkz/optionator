...
(function(){
  ...
  main = function(libOptions){
    ...
    parse = function(input, arg$){
      var ref$, slice, initial, obj, positional, restPositional, overrideRequired, prop, setValue, setDefaults, checkRequired, mutuallyExclusiveError, checkMutuallyExclusive, checkDependency, checkDependencies, args, key, value, option, i$, len$, arg, that, result, short, argName, usingAssign, val, flags, len, j$, len1$, i, flag, opt, name, negated, noedName, valPrime;
      ref$ = arg$ != null
        ? arg$
        : {}, slice = ref$.slice, initial = ref$.initial;
      obj = {};
      if (initial) {
        import$(obj, initial);
      }
