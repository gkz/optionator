...
(function(){
  var VERSION, ref$, id, each, map, compact, all, any, groupBy, chars, isItNaN, keys, Obj, deepIs, closestString, nameToRaw, camelize, dasherize, generateHelp, generateHelpForOption, parsedTypeCheck, parseType, parseLevn, camelizeKeys, parseString, main, toString$ = {}.toString, slice$ = [].slice;
  VERSION = '0.1.0';
  ref$ = require('prelude-ls'), id = ref$.id, each = ref$.each, map = ref$.map, compact = ref$.compact, all = ref$.all, any = ref$.any, groupBy = ref$.groupBy, chars = ref$.chars, isItNaN = ref$.isItNaN, keys = ref$.keys, Obj = ref$.Obj;
